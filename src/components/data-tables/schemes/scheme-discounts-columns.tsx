...
export interface SchemeDiscountRow {
  sNo: string;
  brand: string;
  category: string;
  subCategory: string;
...
export const createSchemeDiscountColumns = (
  options: ColumnOptions
): ColumnDef<SchemeDiscountRow>[] => [
  {
    id: 'sno',
    header: 'S.No',
      ...
      return (
        <div className="min-w-[140px]">
          <Select
            ...
            onValueChange={(value: string) =>
              rowData.onChange?.('discountType', value, rowData.index || 0)
            }
          >
            <SelectTrigger className="w-full">
    ...
    cell: ({ row }) => {
      ...
      return (
        <Input
          ...
          type="number"
          onChange={(e) =>
            rowData.onChange?.('discountValue', e.target.value, rowData.index || 0)
          }
