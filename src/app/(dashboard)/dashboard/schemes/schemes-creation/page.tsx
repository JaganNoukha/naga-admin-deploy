...
import { SchemeProductsTable } from '@/components/data-tables/schemes/scheme-products-table';
import { SchemeDiscountsTable } from '@/components/data-tables/schemes/scheme-discounts-table';
...
const ProductCreatePage = () => {
  ...
  const [schemeProductRows, setSchemeProductRows] = useState<any[]>([]);
  const [schemeDiscountRows, setSchemeDiscountRows] = useState<any[]>([]);
            ...
            <div className="flex flex-col">
              ...
              <p className="text-sm text-neutral-500">
                {isEditMode
                  ...
                  : 'Provide information to create a scheme'}
              </p>
            </div>
          </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="rounded-lg bg-white p-4">
            ...
            <SchemeProductsTable
              ...
              onChange={(tableRows) => {
                setSchemeProductRows(tableRows);
              }}
            />
          </div>
          ...
          <div className="rounded-lg bg-white p-4">
            ...
            <SchemeDiscountsTable
              ...
              onChange={(tableRows) => {
                setSchemeDiscountRows(tableRows);
              }}
            />
          </div>
